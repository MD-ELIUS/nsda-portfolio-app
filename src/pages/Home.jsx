        ...
        <main className="max-w-7xl mx-auto px-4 py-16 space-y-24">
            ...
            <section className="grid md:grid-cols-3 gap-6">
                {[
                    ...
                    <div
                        key={title}
                        className="p-6 rounded-xl bg-gradient-to-br from-indigo-50 to-white shadow-md hover:shadow-xl hover:-translate-y-1 transition"
                    >
            ...
            <section>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div
                            key={title}
                            className="p-8 rounded-xl bg-white shadow-md hover:bg-indigo-50 hover:shadow-xl transition text-center"
                        >
